...
class LFVolBaseNet(torch.nn.Module):
    def __init__(self):
        super(LFVolBaseNet, self).__init__()

        self.conv1 = BasicNet(16, 32)
        self.pool1 = torch.nn.AvgPool2d(kernel_size=2, stride=2)

        self.conv2 = BasicNet(32, 96)
        self.pool2 = torch.nn.AvgPool2d(kernel_size=2, stride=2)

        self.conv3 = BasicNet(96, 128)
    ...
    def forward(self, inputs):
        ...
        # return self.final_subnet(combined_output)
        return upsample1_output
