...
from ..models import DirectNetVolImage6x6


class DirectNetVolImages6x6Experiment(Experiment):
    def __init__(self, config):
        ...
        self.model = DirectNetVolImage6x6(
            vol_images_path=config['vol_images_path']
        )
