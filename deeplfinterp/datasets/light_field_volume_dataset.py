...
class LightFieldVolumeDataset(Dataset):
    ...
    def __init__(self,
                 ...
                 entropy: bool = True,
                 training: bool = True):
        super(LightFieldVolumeDataset, self).__init__()
        self.dataset_loc = dataset_loc
        self.training = training

        if entropy:
            self.rank_rep = \
                np.load('/home/sean/Documents/Development/deeplfvis/inc_reps_side_entropy.npy')
        else:
            self.rank_rep = \
                np.load('/home/sean/Documents/Development/deeplfvis/inc_reps_side_order.npy')
